...
<p>Find the maximum total from top to bottom in <a href="nums.txt">triangle.txt</a> (right click and 'Save Link/Target As...'), a 15K text file containing a triangle with one-hundred rows.</p>
